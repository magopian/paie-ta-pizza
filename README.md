...
Au [Laboratoire Ouvert Ardèche Drôme](https://github.com/l0ad) (L0AD) nous
commandons régulièrement des pizzas.
Et il s'ensuit un calcul de la participation de chacun, et le suivi du
remboursement à la personne qui a payé le livreur :
- les étudiants paient une demi part
- les non étudiants paient le reste

Le calcul est fait de la sorte : il y a 2 étudiants et 3 non étudiants, et le
total de la commande s'élève à 25€.
...
Les étudiants paient chacun 3.125€, les non étudiants paient chacun 3.125€*2 = 6.25€

Le total remboursé est donc de
...
Le suivi des commandes de pizzas et de leurs remboursement est visible sur

https://magopian.github.io/paie-ta-pizza/
...
The data is stored in a [Kinto](kinto.readthedocs.org/) instance.
...
This project is bootstrapped with [Create Elm App](https://github.com/halfzebra/create-Paie ta pizza !
